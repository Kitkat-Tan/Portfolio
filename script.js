...
const pages = {
    ...
    contact: `<h2>CONTACT</h2><label>NAME</label><input type="text" placeholder="Your Name"><label>EMAIL</label><input type="email" placeholder="your.email@example.com"><label>MESSAGE</label><textarea rows="4" placeholder="Write your message here..."></textarea><button>Send Message →</button><div style="margin-top: 30px; border-top: 1px solid var(--accent); padding-top: 20px;"><p>Or find me here:</p><a href="https://facebook.com" target="_blank" style="margin-right: 15px; color: var(--accent);">Facebook</a><a href="https://github.com" target="_blank" style="margin-right: 15px; color: var(--accent);">GitHub</a><a href="https://instagram.com" target="_blank" style="color: var(--accent);">Instagram</a></div>`
};
...
function showPage(page) {
    ...
    area.offsetHeight;
    area.style.animation = 'fadeIn 0.6s ease';
