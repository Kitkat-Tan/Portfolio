...
const pages = {
    ...
    contact: `<h2>CONTACT</h2><label>NAME</label><input type="text" placeholder="Your Name"><label>EMAIL</label><input type="email" placeholder="your.email@example.com"><label>MESSAGE</label><textarea rows="4" placeholder="Write your message here..."></textarea><button>Send Message →</button>
